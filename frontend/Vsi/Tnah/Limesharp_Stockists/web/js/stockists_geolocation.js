        ...
        return {
            ...
            search : function(map, coords, latLng, config) {                        
                ...
                for (i = 0; i < markers.length; i++) { 
                    ...
                    if (distance < radius /*config.radius */) {
                        ...
                        var contentToAppend = "<div class='results-content' data-miles='"+store_distance+"' data-marker='"+markers[i].record_id+"'><p class='results-title geoloc'>"+markers[i].global_name+"</p>";
                        ...
                        if (markers[i].global_phone) {
                            contentToAppend += "<p class='results-phone'><a href='tel:"+markers[i].global_phone+"'>"+markers[i].global_phone+"</a></p>";
                        }
